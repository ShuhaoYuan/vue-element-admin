...
export default {
  ...
  methods: {
    ...
    submit() {
      this.submitting = true
      updateTmp(this.compareData.tmpQuestion.id, this.category.category_id, this.type.isAvailable).then(this.processTmpQuestion)
    },
